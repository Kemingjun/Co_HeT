...
def get_options(args=None):
    ...
    parser.add_argument('--robot_type_num', type=int, default=2, help='Number of robot types')
    ...
    parser.add_argument('--checkpoint_encoder', action='store_true', default=True,
    ...
    opts.run_name = "{}_{}_{}".format(opts.run_name, opts.robot_type_num, time.strftime("%Y%m%dT%H%M%S"))
    opts.save_dir = os.path.join(
        opts.output_dir,
        "{}_{}_{}".format(opts.problem, opts.robot_type_num, opts.graph_size),
        opts.run_name
    )
