...
class AttentionModel(nn.Module):
    ...
    def vehicle_selector(self, vehicle_embeddings, normalize=True):
        ...
        for robot_type_index in range(paramet_hrsp.ROBOT_TYPE_NUM):
            ...
            if robot_selected is None:
                ...
                offset_selected_type_robot = selected_type_vehicle + paramet_hrsp.ROBOT_NUM_LIST[:robot_type_index].sum()
    ...
    def route_max_pool(self, node_embeddings: torch.Tensor,
        ...
        if not torch.is_floating_point(node_embeddings):
            raise TypeError("route_max_pool  node_embeddings  -inf ")
