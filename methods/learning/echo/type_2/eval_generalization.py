...
if __name__ == "__main__":
    ...
    parser.add_argument('--precision', default='32', help="Precision of the trained model")
    ...
    # datasets = [f"K2_20/N{10 + i * 5}_K2_M12" for i in range(5)]
    # datasets = [f"K2_50/N{40 + i * 5}_K2_M12" for i in range(5)]
    datasets = ["N20_K2_M12_0.3_deadline", "N20_K2_M12_0.4_deadline", "N20_K2_M12_0.6_deadline", "N20_K2_M12_0.7_deadline"]
    for width in widths:
