...
class GraphPromptAttentionEncoder(nn.Module):
    def __init__(
            self,
            n_heads,
            embed_dim,
        ...
        super(GraphPromptAttentionEncoder, self).__init__()
    ...
    def forward(self, node, prompt, mask=None):

        assert mask is None, "TODO mask not yet supported!"

        h = self.fiLMPrompt(node, prompt)
